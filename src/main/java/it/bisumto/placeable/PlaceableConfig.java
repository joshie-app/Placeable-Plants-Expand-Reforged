...
public class PlaceableConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> PLACEMENT_BLACKLIST;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> WORLDGEN_BLACKLIST;
    public static final ForgeConfigSpec.BooleanValue DISABLE_EXPANDED_WORLDGEN_PLACEMENT;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> ADDITIONAL_PLACEABLE_PLANTS;
